...
public class RunBank {
    ...
    private static void handleCustomer(Scanner scanner, List<String[]> records, Map<String, Integer> header) {
        ...
        //starting balances of the User's Accounts
        //To be used when generating User transactions file
        double checkStarting = customer.getCheckingAccount().getBalance();
        double savStarting = customer.getSavingsAccount().getBalance();
        double credStarting = customer.getCreditAccount().getBalance();
        ...
        while (!exit) {
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    bankService.userTransactions(customer, checkStarting, savStarting, credStarting);
                    break;
                case 7:
                    exit = true;
