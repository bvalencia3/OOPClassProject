...
public class BankService {
     ...
     * @param lastName
     */
    public void userTransactions(Customer customer, double checkStarting, double savStarting, double credStarting) {
        FileWriterUtility writer = new FileWriterUtility();
        writer.generateTransFile(customer, checkStarting, savStarting, credStarting);
        System.out.println("File generated successfuly.");
    }
